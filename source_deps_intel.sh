...
#source ~/build/gcc-7.3.0_install/use_gcc.sha
source ~/build/intelOneApi/use_intel_toolchain.sh
#source ~/build/llvm_develop/use_clang.sh
#source ~/build/mpich-3.4.1_clang_install/use_mpich.sh
source ~/build/core_intelmpi_install/use_core.sh
...
source ~/build/petsc_intelmpi_3.17.0/opt/use_petsc.sh
