...
reference_element::ReferenceElement getHex(int degree)
{
  reference_element::ReferenceElementGeometry geom(reference_element::getStandardReferenceElementDef());
  auto nodes = reference_element::getLagrangeHexNodes(degree);
